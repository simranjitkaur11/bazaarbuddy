...
# Week2
Day 1-2:Learned to create and manage databases in SQL.
...
Day 3:Prepared marketing materials for the app launch.
Created a promotional video highlighting key features.

Day 5-6:Conducted final security checks on the payment gateway.
Ensured all transactions were encrypted and secure.

# week 2

Day 1-2:Added a help section for users, including FAQs and support contact.
